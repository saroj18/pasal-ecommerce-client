  ...
  return (
    <div className="border-2 border-gray-300 rounded-md p-2 grow w-full">
      ...
      <div className="flex gap-x-2">
        <div className="flex grow justify-center p-2 items-center flex-col gap-y-1 text-blue-500 font-semibold rounded-md cursor-pointer border-2 border-gray-300 ">
          <span>+</span>
