...
const Delevery = () => {
  return (
    <div>
      ...
      <ParaTypo className='text-[15px] opacity-75'>All delevery list</ParaTypo>
        </div>
        ...
        <tbody>
         {
          Array(15).fill(null).map((_,index)=>{
            ...
            <td className="p-2">
              ...
              <Button className='bg-green-500 px-3 py-2 text-white rounded-md'>Delevery Complete</Button>
            </td>
          </tr>
          })
         }
