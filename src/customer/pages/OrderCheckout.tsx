          ...
          .map((_, index) => {
            return (
              ...
              >
                <X
                  size={20}
                  className="absolute left-[97%] opacity-80 cursor-pointer top-0"
                />
                ...
                <div>
                  ...
                  <ParaTypo className="text-[16px] opacity-75">
                    Brand:Samsung
                  </ParaTypo>
                </div>
                <HeadingTypo className="text-xl opacity-75">Qty:3</HeadingTypo>
                <HeadingTypo className="text-xl">Total: 3000</HeadingTypo>
              </div>
            );
          })}
      </div>
      <div className="w-full max-w-[550px] sticky top-0 left-0 h-fit">
