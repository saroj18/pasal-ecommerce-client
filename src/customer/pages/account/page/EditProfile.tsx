      ...
      <form className="grid grid-cols-2 gap-4" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div>
          ...
          {...register('mobile')}
            ...
            type="text"
          />
          {errors.mobile?.message && <ParaTypo className="text-sm text-red-500">{errors.mobile?.message}</ParaTypo>}
        </div>
        <div>
          ...
          {...register('dob')}
            ...
            type="text"
          />
          {errors.dob?.message && <ParaTypo className="text-sm text-red-500">{errors.dob?.message}</ParaTypo>}
        </div>
        <div>
          ...
          {errors.gender?.message && <ParaTypo className="text-sm text-red-500">{errors.gender?.message}</ParaTypo>}
        </div>
        <div>
          ...
          {...register('currentPassword')}
            ...
            type="password"
          />
          {errors.currentPassword?.message && <ParaTypo className="text-sm text-red-500">{errors.currentPassword?.message}</ParaTypo>}
        </div>
        <div>
          ...
          {...register('newPassword')}
            ...
            type="password"
          />
          {errors.newPassword?.message && <ParaTypo className="text-sm text-red-500">{errors.newPassword?.message}</ParaTypo>}
        </div>
        <div>
          ...
          {...register('confirmPassword')}
            ...
            type="password"
          />
          {errors.confirmPassword?.message && <ParaTypo className="text-sm text-red-500">{errors.confirmPassword?.message}</ParaTypo>}
        </div>
