        ...
        <Table className='text-xs md:text-base'>
            ...
            <TableBody>
                ...
                <TableData className='p-2 flex items-center gap-x-2 justify-center'>
                    <Button onClick={()=>navigate('details')} className='bg-green-500 text-white py-2 px-5 rounded-md'>Review</Button>
                    {false && <Button className=' text-white py-2 px-5 rounded-md bg-blue-500'>View</Button>}
                </TableData>
